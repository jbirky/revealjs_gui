...
<head>
  ...
  <style>
    ...
    .reveal .slides section code { background: rgba(255,255,255,0.1); padding: 2px 5px; border-radius: 3px; font-family: monospace; }
    .reveal .slides section pre { background: rgba(0,0,0,0.4); padding: 12px 16px; border-radius: 6px; margin-bottom: 0.4em; overflow: auto; }
    .reveal .slides section pre code { background: none; padding: 0; }
    .reveal .slides section blockquote { border-left: 3px solid rgba(255,255,255,0.3); padding-left: 16px; opacity: 0.8; margin-bottom: 0.4em; }
